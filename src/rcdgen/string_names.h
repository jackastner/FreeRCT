...
static const char *_gui_string_names[] = {
	...
	"COASTER_INSTANCE_EXCITEMENT_TEXT",
	"COASTER_INSTANCE_NAUSEA_TEXT",
	"COASTER_INSTANCE_INTENSITY_TEXT",
	"COASTER_INSTANCE_MAX_HEIGHT_TEXT",
	"COASTER_INSTANCE_DROP_COUNT_TEXT",
	"COASTER_INSTANCE_MAX_DROP_HEIGHT_TEXT",
	"COASTER_INSTANCE_MAX_SPEED_TEXT",
	"COASTER_INSTANCE_AVG_SPEED_TEXT",
	"COASTER_INSTANCE_MAX_LAT_G_TEXT",
	"COASTER_INSTANCE_MAX_POS_VERT_G_TEXT",
	"COASTER_INSTANCE_MAX_NEG_VERT_G_TEXT",
